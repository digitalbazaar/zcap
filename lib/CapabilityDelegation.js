...
module.exports = class CapabilityDelegation extends ControllerProofPurpose {
  ...
  constructor({
    ...
    const hasVerifyProofParams = capabilityAction || controller ||
      currentDate ||
    ...
    if(!hasVerifyProofParams) {
      ...
      // FIXME: remove `capabilityAction`?

      // FIXME: require expectedTarget
  ...
  async validate(
    ...
    try {
      ...
      const purposeParameters = {
        capabilityChain, expectedTarget, expectedRootCapability,
