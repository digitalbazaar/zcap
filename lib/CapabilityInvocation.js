...
module.exports = class CapabilityInvocation extends ControllerProofPurpose {
  ...
  async validate(proof, {verificationMethod, documentLoader, expansionMap}) {
    ...
    try {
      ...
      // first, dereference capability chain
      ...
      /* Next, ensure that `capabilityAction` is an allowed action and that
      ...
      // FIXME: remove any duplicative validation code in this function

      // FIXME: require invocation target to be in proof to simplify this
