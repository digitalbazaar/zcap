...
module.exports = class CapabilityInvocation extends ControllerProofPurpose {
   ...
   */
  constructor({
    expectedTarget, capability, capabilityAction, expectedAction, caveat,
  ...
  async validate(proof, {verificationMethod, documentLoader, expansionMap}) {
    try {
      const {expectedTarget, expectedAction, caveat, suite} = this;
      ...
      const purposeParameters = {
        expectedTarget, expectedAction, capabilityAction, caveat,
