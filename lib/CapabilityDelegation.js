...
module.exports = class CapabilityDelegation extends ControllerProofPurpose {
   ...
   * @param {Array} [options.capabilityChain] - An array of capabilities with
   ...
   * @param {object} [options.verifiedParentCapability] - The previously
   *   verified parent capability, if any.
   ...
   * @param {integer} [options.maxTimestampDelta = Infinity] - A maximum number
   *   of seconds that the date on the signature can deviate from, defaults to
   *   `Infinity`.
